...
class exporter {
   public:
    virtual void operator()(const recorder::event_table_t &event_table, const string_table &strings,
...
class stream_exporter : public exporter {
   ...
   public:
    ...
    void operator()(const recorder::event_table_t &event_table, const string_table &strings,
...
inline void stream_exporter::operator()(const recorder::event_table_t &event_table, const string_table &strings,
